...
public class DiffCallBack<T extends IDiffData> extends DiffUtil.Callback {
    ...
    public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
        T t = mOldDatas.get(oldItemPosition);
        T obj = mNewDatas.get(newItemPosition);
        return t.isEquals(obj);
    }
