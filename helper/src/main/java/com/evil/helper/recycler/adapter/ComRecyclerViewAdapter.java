 ...
 */
public abstract class ComRecyclerViewAdapter<T extends IRecycleData,V extends ComRecyclerViewHolder<T>>
        extends RecyclerView.Adapter<BaseRecyclerHolder> implements IExtendAdapter<T>
{
    ...
    protected void setDefaultItemData(BaseRecyclerHolder holder,int position) {
    }
